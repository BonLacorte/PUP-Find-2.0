...
const AdminUserAuthForm = ({ type }) => {
    ...
    return (
        <section className={'flex justify-center items-center max-w-full h-screen border-red-700 ' }>
            ...
            <div className={'bg-gray-100 bg-opacity-60 backdrop-filter backdrop-blur-lg rounded-xl shadow-md flex justify-center items-center w-max h-full p-10 border-blue-600 ' + ( type != 'register' ? ' lg:w-96 h-max'  : ' lg:w-3/5 xl:w-4/5 min-h-full ' )}>
                    ...
                    <form id="formElement" className='flex flex-col font-semibold align-center w-full gap-2'>

                        {
                            ...
                            <header className="text-center">
                                ...
                                <h1 className="text-3xl font-bold">PUP Find Admin</h1>
...
export default AdminUserAuthForm